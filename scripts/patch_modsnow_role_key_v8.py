#!/usr/bin/env python3
"""Bake: align modsNow with canAccess role-key resolution; bump sync ?v=7 to ?v=8."""
...
# Header bump: match v7 header loosely (arrow encoding-safe)
text2, n_h = re.subn(
    r"/\* Role permission breakdown by live workflow\. Least-privilege: no child.parent elevation\. Child nav: expense\+achievements; lexical NAV_ITEMS via navItemsList \(v7\)\. \*/",
...
if n_h:
    text = text2
    print("bumped sync header to v8")
