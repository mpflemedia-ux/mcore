...
NEW_ITEMS = """        {id:'stg-audit', en:'Audit Log', bm:'Log Audit'},
        {id:'stg-booking', en:'Public booking', bm:'Booking awam'},
        {id:'stg-roles', en:'Role Permissions', bm:'Kebenaran Peranan'}"""
...
NEW_ICONS = """      'stg-backup':'ti-cloud-download', 'stg-fraud':'ti-shield-search', 'stg-audit':'ti-list-details',
      'stg-booking':'ti-calendar-plus', 'stg-roles':'ti-user-shield'"""


def main():
    html = INDEX.read_text(encoding='utf-8')
    changed = False
    if "id:'stg-booking'" not in html and OLD_ITEMS in html:
        html = html.replace(OLD_ITEMS, NEW_ITEMS, 1)
        changed = True
    if "'stg-booking':'ti-calendar-plus'" not in html and OLD_ICONS in html:
